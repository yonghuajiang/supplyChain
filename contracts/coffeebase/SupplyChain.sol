...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole{
  ...
  function renounceDistributor(address account) public onlyOwner{
  ...
  function renounceFarmer(address account) public onlyOwner{
  ...
  function renounceRetailer(address account) public onlyOwner{
